...
public class OrderMsgCodec implements IOrderMsgCodec {
    ...
    public OrderBO getOrderReply(byte[] bytes) {
        ...
        orderBO.setExtNo(bodyDecoder.extNo());
        orderBO.setAcctId(bodyDecoder.acctId());
        orderBO.setExchId(bodyDecoder.exchId());
        orderBO.setSectCode(bodyDecoder.sectCode());
        orderBO.setBsSideId(bodyDecoder.bsSideId());
        orderBO.setPrice(bodyDecoder.price());
        orderBO.setQty(bodyDecoder.qty());
        orderBO.setCntrNo(bodyDecoder.cntrNo());
        orderBO.setBizDate(bodyDecoder.bizDate());
        orderBO.setStateId(bodyDecoder.stateId());
        orderBO.setStateEnteredCode(bodyDecoder.stateEnteredCode());
        orderBO.setCreateTime(bodyDecoder.createTime());
        orderBO.setUpdateTime(bodyDecoder.updateTime());
        return orderBO;
