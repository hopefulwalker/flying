...
public class BaseUCClientService {
    ...
    private ObjectPool<IClientCommEngine> enginePool;
    ...
    public IClientCommEngine borrowEngine() throws Exception {
        if (enginePool != null)
    ...
    public void returnEngine(IClientCommEngine engine) throws Exception {
