...
public class CodeGenerator {
    ...
    private static final String PACKAGE_TEMPLATE = "com.flying.common.msg.converter.generator.pkgdef";
    private static final String CLASS_TEMPLATE = "com.flying.common.msg.converter.generator.classdef";
    private static final String ATTR_TEMPLATE = "com.flying.common.msg.converter.generator.attrdef";

    private static final String GET_HEADER_INFO = "com.flying.common.msg.converter.generator.methodgetheaderinfo";

    private static final String REQUEST_2_BYTES = "com.flying.common.msg.converter.generator.methodrequest2bytes";
    private static final String BYTES_2_REQUEST = "com.flying.common.msg.converter.generator.methodbytes2request";

    private static final String BYTES_2_REPLY_COLLECTION = "com.flying.common.msg.converter.generator.methodbytes2replycollection";
    private static final String BYTES_2_REPLY_DTO = "com.flying.common.msg.converter.generator.methodbytes2replydto";
    private static final String REPLY_COLLECTION_2_BYTES = "com.flying.common.msg.converter.generator.methodreplycollection2bytes";
    private static final String REPLY_DTO_2_BYTES = "com.flying.common.msg.converter.generator.methodreplydto2bytes";
    private static final String REPLY_BASIC_2_BYTES = "com.flying.common.msg.converter.generator.methodreplybasic2bytes";
    ...
    private void prepareRequestFields(Method method, Map<String, Object> vars) {
        ...
        for (Parameter para : parameters) {
            RequestFields requestFields = para.getAnnotation(RequestFields.class);
            if (requestFields == null) continue;
            String name = para.getAnnotation(Name.class).value();
            String[] fields = requestFields.value().split(",");
            for (String field : fields) {
                try {
                    String fieldName = field.trim();
