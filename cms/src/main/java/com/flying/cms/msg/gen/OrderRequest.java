...
public class OrderRequest
{
    ...
    public OrderRequest requestNo(final long value)
    {
    ...
    public static int bsSideId()
    {
        return 3;
    }

    public static String bsSideMetaAttribute(final MetaAttribute metaAttribute)
    {
        switch (metaAttribute)
        {
            case EPOCH: return "unix";
    ...
    public static byte bsSideNullValue()
    {
        return (byte)0;
    }

    public static byte bsSideMinValue()
    {
        return (byte)32;
    }

    public static byte bsSideMaxValue()
    {
        return (byte)126;
    }
    ...
    public byte bsSide()
    {
        return CodecUtil.charGet(buffer, offset + 16);
    }

    public OrderRequest bsSide(final byte value)
    {
        CodecUtil.charPut(buffer, offset + 16, value);
        return this;
    }
    ...
    public int bizDate()
    {
        return CodecUtil.int32Get(buffer, offset + 41, java.nio.ByteOrder.LITTLE_ENDIAN);
    }

    public OrderRequest bizDate(final int value)
    {
        CodecUtil.int32Put(buffer, offset + 41, value, java.nio.ByteOrder.LITTLE_ENDIAN);
        return this;
    }
}
